    ...
    return (
        <div className='mx-auto max-w-[1150px] h-[1600px] grid grid-cols-4 '>
          {allStors.map((stors, index) => (
            <div key={index}>
             <Link to={`/card/${stors.id}`}>
                 <div className="card bg-base-100 w-65 shadow-sm gap-5 mt-5 pl-5  hover:scale-105 transform transition duration-300">
                     <figure>
                       <img
                       src={stors.image}
                       alt="Shoes" />
                     ...
                     <div className="card-body">
                        ...
                        <div className="card-actions flex justify-between">
                              <button><img className='h-[20px] w-[20 px]' src={starPng} alt="" />{stors.ratingAvg}</button>
